...
RUN curl -s http://d3kbcqa49mib13.cloudfront.net/spark-2.4.4-bin-hadoop2.7.tgz | tar -xz -C /usr/local/ && curl -s http://www-us.apache.org/dist/zeppelin/zeppelin-0.8.2/zeppelin-0.8.2-bin-all.tgz | tar -xz -C /usr/local/ 
